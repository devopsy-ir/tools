...
var config = {
    ...
    hosts: {
        ...
        // authdomain: 'meet.insa.lr',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.meet.insa.lr',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'meet.insa.lr',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://meet.insa.lr/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    // websocket: 'wss://meet.insa.lr/' + subdir + 'xmpp-websocket',
    ...
    // focusUserJid: 'focus@auth.meet.insa.lr',

    // Option to send conference requests to jicofo over http (requires nginx rule for it)
    // conferenceRequestUrl:
    //   'https://<!--# echo var="http_host" default="meet.insa.lr" -->/' + subdir + 'conference-request/v1',
    ...
    //     // by default uses:
    //     // 'https://meet.insa.lr/static/oauth.html'
    //     redirectURI:
    //          'https://meet.insa.lr/subfolder/static/oauth.html',
    // },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.meet.insa.lr',
